...
sys.path.append("..")
import jtnn
import fast_jtnn.vocab as vvocab
import rdkit
...
model = jtnn.jtnn_vae.JTNNVAE(vocab, hidden_size, latent_size, depth)
...
dataset = jtnn.datautils.MoleculeDataset(opts.train_path)
