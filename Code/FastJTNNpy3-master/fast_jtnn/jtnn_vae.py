...
class JTNNVAE(nn.Module):
    ...
    def encode_from_smiles(self, smiles_list):
        ...
        z_tree_vecs = self.T_mean(tree_vecs)
        z_mol_vecs = self.G_mean(mol_vecs)
    ...
    def forward(self, x_batch, beta):
        # x_jtenc_holder对应tree encoder，x_mpn_holder对应graph encoder，x_jtmpn_holder对应tree encoder增强的graph decoder
