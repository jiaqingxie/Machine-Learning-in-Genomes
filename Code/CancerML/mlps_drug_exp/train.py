"""
The training process of the MLP model is given in this file.
"""
import os
import torch
...
from mlps_drug_exp.mlp import MLP_simple, MLP_batchnorm, MLP_rawcgc
...
"""
dataFile = os.path.join('.\\data', 'LatentVec_Drug+RawVec_GeneExp(cgc+eliminated+unsampledDrug).txt')
"""
